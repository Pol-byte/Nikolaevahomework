...
name.addEventListener("input", function (event) {
    if (!name.validity.patternMismatch) {
      ...
      name.setCustomValidity("Имя должно начинаться с большой буквы, состоять из букв английского или русского алфавита и содержать в себе только буквы");
    }
  });
...
secname.addEventListener("input", function (event) {
    if (!secname.validity.patternMismatch) {
        ...
        secname.setCustomValidity("Фамилия должна начинаться с большой буквы, состоять из букв английского или русского алфавита и содержать в себе только буквы");
    }
  });
...
surname.addEventListener("input", function (event) {
    if (!fathername.validity.patternMismatch) {
        ...
        surname.setCustomValidity("Отчество должно начинаться с большой буквы, состоять из букв английского или русского алфавита и содержать в себе только буквы");
    }
  });
